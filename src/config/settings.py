...
ITERATIVE_OPTIMIZATION_INITIAL_POPULATION_SIZE = int(1e2) 
ITERATIVE_OPTIMIZATION_POPULATION_SIZE = int(1e1) * 1
ITERATIVE_OPTIMIZATION_RECOMBINATIONS_PER_ITERATION = int(1e3)
ITERATIVE_OPTIMIZATION_ITERATIONS_PER_CYCLE = int(1e3) * 1
ITERATIVE_OPTIMIZATION_CYCLES = int(1e1) * 2
